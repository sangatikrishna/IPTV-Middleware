...
import packages_detailsRoute from "./routes/packages_detailsRoute.js";
import packages_livetvsRoute from "./routes/packages_livetvsRoute.js"
...
import adonsBillingTypesRoute from "./routes/adonsBillingTypesRoute.js";
import CustomError from "./utils/CustomError.js";
...
// import packagesvodcategoriesRoute from "./routes/packagesvodcategoriesRoute.js";
// import paymentsettingsRoute from "./routes/paymentsettingsRoute.js";
import SazpinnewcustomersRoutes from "./routes/sazpinnewcustomersRoutes.js"
import administratorsRoute from "./routes/administratorsRoute.js";
...
import SazpinnewcustomerRoutes from "./routes/sazpinnewcustomerRoutes.js";
import resellersRoute from "./routes/resellersRoute.js";
import saz_playlist_1Route from "./routes/saz_playlist_1Route.js";
import saz_playlist_2Route from "./routes/saz_playlist_2Route.js";
import saz_playlist_3Route from "./routes/saz_playlist_3Route.js";
...
// import adonsBillingTypesRoute from "./routes/adonsBillingTypesRoute.js";
// import ResellersRoute from "./routes/resellersRoute.js";
import resellerRoutes from "./routes/resellersRoute.js";

// import resellersRoute from "./routes/resellersRoute.js"
// import SazpinnewcustomersRoutes from "./routes/SazpinnewcustomersRoutes.js"
import demo_saz_playlist_1Route from "./routes/demo_saz_playlist_1Route.js"
import demo_saz_playlist_2Route from "./routes/demo_saz_playlist_2Route.js";
import demo_saz_playlist_3Route from "./routes/demo_saz_playlist_3Route.js"
...
app.use(packages_detailsRoute);
app.use(packages_livetvsRoute)
...
app.use(adonsBillingTypesRoute);
...
app.use(SazpinnewcustomersRoutes);
...
// app.use(SazpinnewcustomersRoutes);
app.use(demo_saz_playlist_1Route);
app.use(demo_saz_playlist_2Route);
app.use(demo_saz_playlist_3Route);
app.use(SazpinnewcustomerRoutes);
app.use(resellersRoute);
app.use(saz_playlist_1Route);
app.use(saz_playlist_2Route);
app.use(saz_playlist_3Route);
...
app.use("/api/packages_vodcategories", packagesvodcategoriesRoute);
app.use("/api/payment_settings", paymentsettingsRoute);
app.use("/api/packages_details",packages_detailsRoute);
app.use("/api/packages_livetvs", packages_livetvsRoute)
...
app.use("/api/resellers", resellersRoute);
...
app.use("/api/customer_saz3", customersaz3Routes);
...
app.use("/api/sazpinewcustomer", SazpinnewcustomersRoutes);
...
// app.use("/api/customers",SazpinnewcustomersRoutes);
app.use("/api/demo_saz_playlist_1",demo_saz_playlist_1Route);
app.use("/api/demo_saz_playlist_2",demo_saz_playlist_2Route);
app.use("/api/demo_saz_playlist_3",demo_saz_playlist_3Route);
app.use("/api/administrators", administratorsRoute);
app.use("/api/customers", SazpinnewcustomerRoutes);
app.use("/api/resellers", resellersRoute);
app.use("/api/saz_playlist_1",saz_playlist_1Route);
app.use("/api/saz_playlist_2",saz_playlist_2Route);
app.use("/api/saz_playlist_3",saz_playlist_3Route);
