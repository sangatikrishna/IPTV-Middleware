...
const AddCategorySong = () => {
  ...
  useEffect(() => {
    if (_id) {
      ...
      axios
        .get(`http://localhost:5001/api/song_categories/${_id}`)
        .then((response) => {
...
const handleSubmit = (e) => {
  ...
  if (_id) {
    ...
    const apiUrl = `http://localhost:5001/api/song_categories/patch/${_id}`; // Edit
    axios
    ...
    const apiUrl = "http://localhost:5001/api/song_categories/post"; // Add
    axios
