...
const Customer_Saz3 = () => {
  ...
  const fetchData = () => {
    fetch("http://localhost:5001/api/customer_saz3/get")
      .then((response) => response.json())
      .then((json) => setAllcustomer_saz3(json.data));
  };
      ...
      },
      {
        ...
        renderCell: (params) => {
          ...
          const handleDeleteConfirmation = () => {
            ...
            axios
              .delete(`http://localhost:5001/api/customer_saz3/delete/${deleteItemId}`)
              .then((response) => {
    ...
    <Box m={isSmallScreen ? "1rem" : "1.5rem 3.5rem"} ml={isSmallScreen ? "10px" : "300px"}mt={isSmallScreen ? "70px" : "undefined"}>
      ...
      >
        ...
        <Container sx={{height:700}}>
               <DataGrid   sx={{ mt: isSmallScreen ? "10px" : "-200px" }} 
               getRowId={(row) => row._id}
         
            rows={allcustomer_saz3}
            columns={columns}
          />
        </Container>
