...
const Addcustomer_saz2 = () => {
  ...
  useEffect(() => {
    if (_id) {
      ...
      axios
        .get(`http://localhost:5001/api/customer_saz2/${_id}`)
        .then((response) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (_id) {
      ...
      const apiUrl = `http://localhost:5001/api/customer_saz2/patch/${_id}`; // Edit
      axios
      ...
      const apiUrl = "http://localhost:5001/api/customer_saz2/post"; // Add
      axios
...
export default Addcustomer_saz2;