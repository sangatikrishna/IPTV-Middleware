...
// url: "",
  ...
  useEffect(() => {
    if (_id) {
      ...
      axios
        .get(`http://localhost:5001/api/customer_saz1/${_id}`)
        .then((response) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (_id) {
      ...
      const apiUrl = `http://localhost:5001/api/customer_saz1/patch/${_id}`; // Edit
      axios
      ...
      const apiUrl = "http://localhost:5001/api/customer_saz1/post"; // Add
      axios
