...
const AddTimeShift = () => {
  ...
  useEffect(() => {
    if (_id) {
      ...
      axios
        .get(`http://localhost:5001/api/Demoplaylist2/${_id}`)
        .then((response) => {
...
const handleSubmit = (e) => {
  ...
  if (_id) {
    ...
    const apiUrl = `http://localhost:5001/api/Demoplaylist2/patch/${_id}`; // Edit
    axios
    ...
    const apiUrl = "http://localhost:5001/api/Demoplaylist2/post"; // Add
    axios
