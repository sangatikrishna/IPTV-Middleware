...
const Demoplaylist1 = () => {
  ...
  const fetchData = () => {
    fetch("http://localhost:5001/api/demo_saz_playlist_1/find")
      .then((res) => res.json())
      .then((res) => {
        console.log(res);
  ...
  const handleEditAction =        (_id) =>
        {
          navigate(`/Demo_saz_playlist_1/Add_Playlist/${params.row._id}`);
        ...
        const handleDeleteConfirmation = () => {
          ...
          axios
            .delete(`http://localhost:5001/api/demo_saz_playlist_1/delete/${deleteItemId}`)
            .then((response) => {
