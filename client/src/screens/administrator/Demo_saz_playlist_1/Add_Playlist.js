...
const Adddemoplaylist1 = () => {
  ...
  useEffect(() => {
    if (_id) {
      axios
        .get(`http://localhost:5001/api/demo_saz_playlist_1/${_id}`)
        .then((response) => {
...
// setValidationError(null);
    ...
    if (_id) {
      ...
      const apiUrl = `http://localhost:5001/api/demo_saz_playlist_1/patch/${_id}`; // Edit
      axios
      ...
      const apiUrl = "http://localhost:5001/api/demo_saz_playlist_1/post"; // Add
      axios
...
export default Adddemoplaylist1;
