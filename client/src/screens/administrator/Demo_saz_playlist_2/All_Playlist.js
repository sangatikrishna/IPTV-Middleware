...
const Demoplaylist2 = () => {
  ...
  const fetchData = () => {
    fetch("http://localhost:5001/api/demo_saz_playlist_2/find")
      .then((res) => res.json())
      .then((res) => {
        console.log(res);
  ...
  const handleEditAction =        (_id) =>
        {
          navigate(`/Demo_saz_playlist_2/Add_Playlist/${params.row._id}`);
        ...
        const handleDeleteConfirmation = () => {
          ...
          axios
            .delete(`http://localhost:5001/api/demo_saz_playlist_2/delete/${deleteItemId}`)
            .then((response) => {
