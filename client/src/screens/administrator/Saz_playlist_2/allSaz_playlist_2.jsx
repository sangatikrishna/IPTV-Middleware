...
const AllSaz_playlist_2 = () => {
  ...
  const [allsaz_playlist_2, setsaz_playlist_2] = useState([]);
  const fetchData = () => {
    fetch("http://localhost:5001/api/saz_playlist_2/find")
      .then((response) => response.json())
      .then((json) => setsaz_playlist_2(json.data));
  };
  console.log(allsaz_playlist_2);
  ...
  const columns = [
...

    {
      ...
      renderCell: (params) => {
        ...
        {
          navigate(`/Saz_playlist_2/Add_Playlist/${params.row._id}`);
        ...
        const handleDeleteConfirmation = () => {
          ...
          axios
            .delete(`http://localhost:5001/api/saz_playlist_2/delete/${deleteItemId}`)
            .then((response) => {
...
export default AllSaz_playlist_2;