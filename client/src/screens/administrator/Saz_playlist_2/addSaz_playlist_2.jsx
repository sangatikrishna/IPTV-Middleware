...
const AddSaz_playlist_2 = () => {
  ...
  useEffect(() => {
    if (_id) {
      ...
      axios
        .get(`http://localhost:5001/api/saz_playlist_2/${_id}`)
        .then((response) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (_id) {
      ...
      const apiUrl = `http://localhost:5001/api/saz_playlist_2/patch/${_id}`; // Edit
      axios
      ...
      const apiUrl = "http://localhost:5001/api/saz_playlist_2/post"; // Add
      axios
...
export default AddSaz_playlist_2;