...
const Adddemoplaylist3 = () => {
  ...
  useEffect(() => {
    if (_id) {
      axios
        .get(`http://localhost:5001/api/demo_saz_playlist_3/${_id}`)
        .then((response) => {
...
// setValidationError(null);
    ...
    if (_id) {
      ...
      const apiUrl = `http://localhost:5001/api/demo_saz_playlist_3/patch/${_id}`; // Edit
      axios
      ...
      const apiUrl = "http://localhost:5001/api/demo_saz_playlist_3/post"; // Add
      axios
...
export default Adddemoplaylist3;
