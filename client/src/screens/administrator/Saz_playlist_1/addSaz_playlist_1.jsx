...
const AddSaz_playlist_1 = () => {
  ...
  useEffect(() => {
    if (_id) {
      ...
      axios
        .get(`http://localhost:5001/api/saz_playlist_1/${_id}`)
        .then((response) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (_id) {
      ...
      const apiUrl = `http://localhost:5001/api/saz_playlist_1/patch/${_id}`; // Edit
      axios
      ...
      const apiUrl = "http://localhost:5001/api/saz_playlist_1/post"; // Add
      axios
...
export default AddSaz_playlist_1;