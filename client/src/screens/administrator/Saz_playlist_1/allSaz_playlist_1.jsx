...
import { Menu as MenuIcon, IconButton ,Dialog,DialogTitle, DialogContent,DialogActions} from "@mui/material";

import SidebarAllCategory from "components/SidebarAllCategories";

const AllSaz_playlist_1 = () => {
  ...
  const [allsaz_playlist_1, setsaz_playlist_1] = useState([]);
      const fetchData = () => {
        fetch("http://localhost:5001/api/saz_playlist_1/find")
          .then((response) => response.json())
          .then((json) => setsaz_playlist_1(json.data));
      };
      console.log(allsaz_playlist_1);
  ...
  const columns = [
...

    {
      ...
      flex: 1,
        ...
        {
          navigate(`/Saz_playlist_1/Add_Playlist/${params.row._id}`);
        ...
        const handleDeleteConfirmation = () => {
          ...
          axios
            .delete(`http://localhost:5001/api/saz_playlist_1/delete/${deleteItemId}`)
            .then((response) => {
...
export default AllSaz_playlist_1;